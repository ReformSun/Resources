! function t(e, r, n) {
    ...
    1: [function (t, e, r) {
        ...
        function u(t) {
            this.callback_ = t, this.nodes_ = [], this.records_ = [], this.uid_ = ++E
        }
        ...
        function l(t) {
            return D ? D : (D = c(A), D.oldValue = t, D)
        }
                ...
                switch (t.stopImmediatePropagation(), t.type) {
                    ...
                    case "DOMNodeInserted":
                        ...
                        var c = d.previousSibling,
                            f = d.nextSibling,
                            i = h("childList", n);
                        i.addedNodes = a, i.removedNodes = u, i.previousSibling = c, i.nextSibling = f, s(n, function (t) {
    ...
    2: [function (t, e, r) {
        ...
        c = t("./utils"), s = c.detectIE() || 0 / 0, 9 > s ? t("json2") : (window.MutationObserver = t("mutation-observer"), a = t("tree-mirror")), u = t("./info"), c = t("./utils"), i = t("./messaging_observer"), o = t("./server_imp_setting"), d = c.detectIOS() || 0 / 0, n = function () {
            ...
            var e, r, n, s, p, f, g, v, m, w, b, y, S, C, O, N, x, I;
            return s = null, O = 3, f = [], r = {}, p = {}, I = {
                tspan: 1,
                text: 1,
                g: 1,
                rect: 1,
                ...
                desc: 1,
                title: 1
            }, v = {}, x = null, g = null, N = null, n = !0, e = ["TEXTAREA", "HTML", "BODY"], S = ["button", "submit"], C = ["A", "BUTTON", "INPUT", "IMG"], w = ["I", "SPAN", "EM", "svg"], y = ["A", "BUTTON"], b = y, m = ["radio", "checkbox"], t.prototype.setPageGroup = function (t) {
                return r.pg = t, this.pageLoaded && +Date.now() - this.pageLoaded < 4e3 ? setTimeout(function (e) {
                    return function () {
                        var r;
                        return e.trackPageView(3), null != (r = e.messagingObserver) ? r.sendPageLoad({
                            pg: t
                        }) : void 0
                    }
                }(this), 10) : void 0
                ...
                return window.grcs.cs1 = t + ":" + e, t && e && this.gruser ? this.gruser.hasSid() ? (this.gruser.isNeedToUpdateSessionByCS(window.vds.accountId) && (this.pageLoaded = +Date.now()), this.gruser.handleCSChanged(window.vds.accountId), setTimeout(function (t) {
                    return function () {
                        return r = p, +Date.now() - t.pageLoaded > 1e4 ? t.trackPageView(4) : t.trackPageView()
                    }
                    ...
                    initialize: function (t) {
                        return function (e) {
                            ...
                            for (a = {
                                    ...
                                    p: t.currentPath
                                }, t.currentQuery.length > 0 && (a.q = t.currentQuery), t.setPSForActionMessage(a), n = [], i = 0, o = e.length; o > i; i++) r = e[i], "use" !== r.tagName && (n = n.concat(t.getLeafNodes(r, e.length)));
                            return a.e = n, n.length > 0 ? t.send([a]) : void 0
                        }
                    }(this),
                        ...
                        return function (e, r, n, i) {
                            ...
                            if (r.length > 0 && !document.body.className.match(/\bvds-entrytext\b/)) {
                                for (t.gruser.hasSid() || (t.pageLoaded = +Date.now(), t.trackPageView(2)), u = {
                                        ...
                                        d: window.location.host || window.vds.accountId,
                                        p: t.currentPath
                                    }, t.currentQuery.length > 0 && (u.q = t.currentQuery), t.setPSForActionMessage(u), o = [], a = 0, s = r.length; s > a; a++) d = r[a], "use" !== d.tagName && (o = o.concat(t.getLeafNodes(d, d.length)));
                                if (u.e = o, o.length > 0) return f.push(u), 0 > O ? t.sendQueue() : (t.queueTimeout && clearTimeout(t.queueTimeout), t.queueTimeout = setTimeout(function () {
                                    return t.sendQueue()
                ...
                return this.lastSentTime = this.lastSentTime || +Date.now(), this.lastSentTime && (+Date.now() - this.lastSentTime) / f.length > 300
            }, t.prototype.checkingBlance = function () {
                return this.idle() ? O -= 1 : void 0
            }, t.prototype.sendQueue = function () {
                return f.length > 0 && +Date.now() - this.lastActionTime < 12e4 && this.send(f), this.queueTimeout = null, this.lastSentTime = +Date.now(), f = [], O = 3
            }, t.prototype.getLeafNodes = function (t, e) {
                var r, n, i, o, a, s, d, h, l, p, f, g, v, m, w, y, S;
                if (d = [], g = !0, t.leaf) 1 === t.nodeType && ((null != (v = t.attributes) ? v.href : void 0) || null != t.text || null != t.obj) && (f = this.nodeMessage(t, !0), e > 1 && (f.idx = t.idx), d.push(f));
                else if (t.isContainer && (f = this.nodeMessage(t, !0), d.push(f)), 0 === t.childNodes.length && -1 === c.indexOf(C, t.tagName));
                else {
                    for (m = t.childNodes, o = 0, h = m.length; h > o; o++) n = m[o], n.leaf || (g = !1), "use" !== n.tagName && (d = d.concat(this.getLeafNodes(n, t.childNodes.length)));
                    if ((-1 !== c.indexOf(b, t.tagName) || g && ((null != (w = t.attributes) ? w.any : void 0) || t.text)) && (t.text || (i = t.dom, t.text = i ? u.containerElemContent(i) : c.parentOfLeafText(t)), f = this.nodeMessage(t, !1), d.push(f)), "SPAN" === t.tagName)
                        for (y = t.childNodes, a = 0, l = y.length; l > a; a++)
                            if (n = y[a], "svg" === n.tagName)
                                for (S = n.childNodes, s = 0, p = S.length; p > s; s++) r = S[s], 1 === r.nodeType && "use" === r.tagName && c.hasAttr(r, "xlink:href") && (t.text = r.getAttribute("xlink:href"), f = this.nodeMessage(t, !1), d.push(f))
                }
                return d
                ...
                s = {
                    ...
                    return t.which > 1 || (N = +Date.now(), g === N) ? void 0 : (g = N, v = {
                        time: N,
                    ...
                    var e;
                    return e = +Date.now() - v.time, e > 1e3 ? clearTimeout(x) : void 0
                }, d = function (t, e) {
                    var r;
                    return r = n ? e.touches[0] : e, r["page" + t.toUpperCase()]
                }, i = function () {
                    var t, e, i, o, a, s, u, d, c, f, g, v, m, w;
                    w = navigator.userAgent, o = /chrome/i.exec(w), i = /android/i.exec(w), n = "ontouchstart" in window && !(o && !i), v = n ? ["touchstart"] : ["mousedown"], m = n ? ["touchend", "touchcancel"] : ["mouseup", "mouseleave"], f = n ? ["touchmove"] : ["mousemove"];
                    for (e = 0, u = v.length; u > e; e++) t = v[e], r(document, t, l);
                    for (a = 0, d = f.length; d > a; a++) t = f[a], r(document, t, h);
                    for (g = [], s = 0, c = m.length; c > s; s++) t = m[s], g.push(r(document, t, p));
                    return g
                }, a = function (t) {
                    return function (r) {
                        var n, i, o, a, d;
                ...
                var t, e, r;
                return t = this.gruser.currentSessionId(), r = t[0], e = t[1], this.gruser.lastSessionId !== r ? (r || (r = this.gruser.guid(), this.gruser.resetUserId()), e = !1, this.gruser.updateSessionId(r, e), this.trackPageView(4)) : void 0
                ...
                var e, n;
                return null == t && (t = 0), e = [], 3 !== t || null != r.pg ? 4 === t && (this.pageLoaded = +Date.now(), this.gruser.isSendNewVisit()) ? void this.trackPageView(2) : (3 > t && this.gruser.isSendNewVisit() && e.push(this.visitMessage()), null == this.pageLoaded && (this.pageLoaded = +Date.now()), 2 === t && (r = p), n = this.pageMessage(), e.push(n), this.send(e, "pv"), this.lastActionTime = +Date.now()) : void 0
                ...
                null == n && (n = {}), c = [], h = {
                    ...
                    p: this.currentPath,
                    n: t
                }, this.currentQuery && this.currentQuery.trim().length > 0 && (h.q = this.currentQuery), v = {}, i = [];
                for (f in n) Array.isArray(n[f]) ? i.push(f) : v[f] = n[f];
                if (0 === i.length) h.e = n, c.push(h);
                else if (1 === i.length && n[i[0]].length > 0)
                    for (g = n[i[0]], a = 0, u = g.length; u > a; a++) {
                        if (o = g[a], "object" == typeof o) {
                            for (f in v) o[f] = v[f];
                            l = Object.assign({}, h), l.e = o
                        } else p = Object.assign({}, v), p[i[0]] = o, l = Object.assign({}, h), l.e = p;
                        c.push(l)
                    } else {
                ...
                var r, n, i, o, a, s, d, h, l, p, f, g, v, w, y, C, O, N, x, I;
                if (n = {}, x = e.tagName, "IMG" === x ? (null != (C = e.src) ? C.length : void 0) > 0 && -1 === e.src.indexOf("data:image") && (n.h = e.src) : c.hasAttr(e, "href") && (i = e.getAttribute("href"), i && 0 !== i.indexOf("javascript") && (n.h = c.normalizePath(i.slice(0, 320)))), c.hasAttr(e, "data-growing-title") && e.getAttribute("data-growing-title").length > 0) n.v = e.getAttribute("data-growing-title");
                else if (c.hasAttr(e, "title") && e.getAttribute("title").length > 0) n.v = c.processText(e.getAttribute("title"));
                else if ("click" === t)
                    if (u.isLeaf(e))
                        if ("IMG" === x) e.alt ? n.v = e.alt : n.h && (s = n.h.split("?")[0], a = s.split("/"), a.length > 0 && (n.v = a[a.length - 1]));
                        else if ("INPUT" === x && -1 !== c.indexOf(S, e.type)) n.v = c.processText(e.value);
                else if ("svg" === x)
                    for (O = e.childNodes, o = 0, w = O.length; w > o; o++) r = O[o], 1 === r.nodeType && "use" === r.tagName && c.hasAttr(r, "xlink:href") && (n.v = r.getAttribute("xlink:href"));
                else I = "", null != e.textContent ? I = e.textContent.replace(/[\n \t]+/g, " ").trim() : null != e.innerText && (I = e.innerText.replace(/[\n \t]+/g, " ").trim()), I.length > 0 && (I.length < 50 ? n.v = c.processText(I) : "A" === x && (n.v = c.processText(I.slice(0, 50))));
                    ...
                    for (N = e.getElementsByTagName("input"), f = 0, y = N.length; y > f; f++) d = N[f], ("search" === d.type || "text" === d.type && ("q" === d.id || -1 !== d.id.indexOf("search") || -1 !== d.className.indexOf("search") || "q" === d.name || -1 !== d.name.indexOf("search"))) && (n.x = u.path(d).xpath, n.v = c.processText(d.value.trim()));
                return n
            }, t.prototype.registerCircleHandler = function () {
                var t;
                try {
                    if (!this.messagingObserver) return this.messagingObserver = new i, this.messagingObserver.sendPageLoad(p)
                } catch (e) {
                    t = e
                }
                ...
                if (!this.domLoadedHandler.done) {
                    if (this.domLoadedHandler.done = !0, this.registerEventListener(), null != a && window.vds.imp) {
                        o.initialize(), window.vds.impCtrlDua && (window.grImpCtrl = Date.now());
                        try {
                ...
                var t;
                return t = !1, window.vds.sampling && (c.functionDeserialization(window.vds.sampling_func).call(this) || (t = !0)), window.grBlind = t, t
                ...
                var e, r, n, i, o, a, s, u;
                for (this.pluginLoaded = !1, s = document.getElementsByTagName("script"), i = 0, o = s.length; o > i; i++)
                    if (n = s[i], u = n.getAttribute("src"), null != u && -1 !== u.indexOf("/outer-circle-plugin.js")) {
                        this.pluginLoaded = !0;
                        break
    ...
    5: [function (t, e, r) {
        ...
        u = t("./guid"), a = t("cookie"), f = t("./utils"), o = /(^| )(clear|clearfix|active|hover|enabled|hidden|display|focus|disabled|ng-|growing-)[^\. ]*/g, s = /\.?([a-zA-Z0-9\-]+\.[a-zA-Z]{2,6})$/, l = ["I", "SPAN", "EM", "svg"], d = f.detectIE() || 0 / 0, i = function () {
            ...
            function t() {
                this.userId = null, this.sessionId = "", this.lastSessionId = "", this.cookieDomain(), this.guid = u
            }
            return t.prototype.duration10year = 31536e4, t.prototype.duration30min = 1800, t.prototype.duration15min = 9e5, t.prototype.duration1min = 6e4, t.prototype.cookieDomain = function () {
                var t, e;
                ...
                var t, e, r, n;
                return e = +Date.now(), this.sessionId && this.lastUpdated && e - this.lastUpdated < this.duration15min ? !0 : (r = this.currentSessionId(), t = r[0], n = r[1], t && (!this.lastSessionId || t === this.lastSessionId))
            }, t.prototype.sid = function () {
                var t, e, r;
                return e = this.currentSessionId(), this.sessionId = e[0], r = e[1], t = +Date.now(), this.sessionId && this.lastUpdated && t - this.lastUpdated < this.duration1min ? this.sessionId : (this.sessionId || (this.sessionId = this.guid(), r = !1, this.updateSessionId(this.sessionId, r)), this.lastUpdated = t, this.lastSessionId = this.sessionId, this.sessionId)
            }, t.prototype.updateSessionId = function (t, e, r) {
                return null == r && (r = window.vds.accountId), t ? (a.setItem("gr_session_id_" + r, t, this.duration30min, "/", this.cookieDomain()), this.lastSessionId = t, this.updateSessionIdSendStatus(e, t, r), e ? void 0 : this.bindCS1WithSession(t)) : (console && console.error("sid shoud not be empty!"), this.sessionId = this.guid(), void this.updateSessionId(this.sessionId, e, r))
            }, t.prototype.updateSessionIdSendStatus = function (t, e, r) {
                var n, i, o, s;
                for (null == r && (r = window.vds.accountId), o = a.keys(), n = 0, s = o.length; s > n; n++)
                    if (i = o[n], i.match(/^gr_session_id_.*_/) && i.slice(i.lastIndexOf("_") + 1) !== e) {
                ...
                var e, r, n, i;
                return r = this.currentSessionId(t), i = r[0], n = r[1], e = this._currentSessionBindedCS1(i), i && i.trim().length > 0 && window.grcs.cs1 && e && e !== window.grcs.cs1
            }, t.prototype.currentSessionId = function (t) {
                var e, r, n;
                return null == t && (t = window.vds.accountId), n = a.getItem("gr_session_id_" + t || ""), r = "true" === a.getItem("gr_session_id_" + t + "_" + n), n && n.indexOf("_") >= 0 && (e = n.split("_"), n = e[0], r = e[1], r = "true" === r, this.updateSessionId(n, r)), n && "null" === n && (n = "", r = !1), [n, r]
                ...
                var e, r, n;
                return null == t && (t = window.vds.accountId), e = this.currentSessionId(t), n = e[0], r = e[1], r === !0
        ...
        }(), h = ["TR", "LI", "DL"], p = ["A", "BUTTON"], c = {
            user: function () {
                return new n
            },
            path: function (t, e) {
                var r, n, o, a, s, u, d, c, h, l, g, v, m, w, b, y, S, C, O;
                if (null == e && (e = !1), a = "", g = !1, n = {}, h = !1, c = !1, S = void 0, s = 0, y = [], o = [], t === document) return {
                    isIgnore: !0
                };
                if (t.tagName) {
                    for (r = new i(t);
                    ...
                    return C = {
                        ...
                        containerMessage: o,
                        isIgnore: g
                    }, h && (C.obj = d), c && (C.idx = u), S && (C.pnode = S), C
                }
            },
            index: function (t) {
                var e, r, n, i, o, a, s;
            ...
            depthInside: function (t, e, r) {
                ...
                if (null == r && (r = 1), t.hasChildNodes()) {
                    ...
                    for (a = t.childNodes, n = 0, i = a.length; i > n; n++)
                        if (o = a[n], 1 === o.nodeType && !c.depthInside(o, e, r + 1)) return !1
                }
                return e >= r
            },
            onlyContainsChildren: function (t, e) {
                ...
                for (o = t.children, n = 0, i = o.length; i > n; n++)
                    if (r = o[n], -1 === f.indexOf(e, r.tagName)) return !1;
                return !0
            },
    ...
    6: [function (t, e, r) {
        var n, i, o, a, s, u, d, c, h, l, p, f, g, v, m, w = [].slice;
        if (t("./shim"), i = t("./tracker"), n = t("./dom_observer"), m = t("./utils"), h = t("./guid"), u = [], c = new n, v = new i(c), window._gr_support_circle_pop_out = !0, a = function () {
                var t, e, r;
                r = arguments[0], t = 2 <= arguments.length ? w.call(arguments, 1) : [];
                try {
                    if (null != v[r]) return v[r].apply(v, t);
                    if (null != c[r]) return c[r].apply(c, t)
                } catch (n) {
                    return e = n, console && console.error(e)
                }
            }, !window.vds || !window.vds.origin) {
            for (null == window._vds && (window._vds = [
                    ["setAccountId", "22222-22222-22222-22222"]
                ]), f = window._vds, l = 0, p = f.length; p > l; l++) s = f[l], "track" === (g = s[0]) ? u.push(s) : a.apply(null, s);
            window._vds = {
                push: function () {
                ...
                return r
            }, m.identityWindow(), d = function (t) {
                return function (e, r) {
                    return c.observe(e, r), t()
                }
            }, -1 === m.indexOf(["", "localhost", "127.0.0.1"], window.location.hostname) && v.connect(d(o))
        }
    }, {
        "./dom_observer": 2,
        "./guid": 4,
    ...
    7: [function (t, e, r) {
        ...
        a = t("./utils"), o = ["load-plugin", "circle-mode", "browse-mode"], i = ["load-plugin", "register-iframe", "circle-mode", "browse-mode", "page-load", "circle-load"], n = function () {
            function t() {
                this.registerInnerIframe = s(this.registerInnerIframe, this), this.sendPageLoad = s(this.sendPageLoad, this), this.isSdkEvent = s(this.isSdkEvent, this), this.allowOrigin = window.vds.origin, this.bindEvents()
            }
            return t.prototype.bindEvents = function () {
                return a.bind(window, "message", function (t) {
                    return function (e) {
                        ...
                        if (r = e.data, r.ai === window.vds.accountId && (n = r.mode || r.circleMode, t.isSdkEvent(n) && (!r.fsna || "sdk" === r.fsna))) {
                            ...
                            if (s = r.mode, u.call(o, s) >= 0 || r.tna === window.grSource.name || e.origin === window.vds.origin || -1 !== a.indexOf(["www.growingio.com", "growingio.com"], e.origin.split("://")[1])) switch (e.origin !== window.vds.origin && (window.vds.origin = e.origin), r.mode) {
                                case "load-plugin":
                ...
                var e, r, n, i, o;
                null == t && (t = null), i = (null != (n = window.vds) ? n.pathCaseSensitive : void 0) ? window.location.toString() : window.location.toString().toLowerCase();
                for (e in vds) o = vds[e], "function" == typeof o && (vds[e] = a.functionSerialization(o));
                return r = {
                ...
                var t, e, r, n, i, o, s, u;
                for (this.pluginLoaded = !1, t = a.getCirclePluginFileName(window._gr_support_circle_pop_out), s = document.getElementsByTagName("script"), i = 0, o = s.length; o > i; i++)
                    if (n = s[i], u = n.getAttribute("src"), null != u && -1 !== u.indexOf("/" + t + ".js")) {
                        this.pluginLoaded = !0;
                        break
                ...
                var t, e, r, n, i, o;
                if (t = a.getCirclePluginFileName(window._gr_support_circle_pop_out), !this.pluginLoaded)
    ...
    8: [function (t, e, r) {
        ...
        u = t("lzstring"), h = t("./utils"), a = h.detectIE() || 0 / 0, d = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./), o = d ? parseInt(d[2], 10) : !1, s = !1, o && 22 > o ? n = !1 : (n = !0, c = navigator.userAgent, "ArrayBufferView" in window || (-1 !== c.indexOf("Android") ? n = !1 : -1 !== c.indexOf("CPU OS ") ? -1 !== c.indexOf("CPU OS 6_") ? n = !1 : -1 !== c.indexOf("CPU OS 5_") ? n = !1 : -1 !== c.indexOf("CPU OS 4_") ? n = !1 : -1 !== c.indexOf("CPU OS 3_") && (n = !1) : -1 !== c.indexOf("CPU iPhone OS ") ? -1 !== c.indexOf("iPhone OS 6_") ? n = !1 : -1 !== c.indexOf("iPhone OS 5_") ? n = !1 : -1 !== c.indexOf("iPhone OS 4_") && (n = !1) : -1 !== c.indexOf("Intel Mac OS X") && (-1 !== c.indexOf("Mac OS X 10_6") ? n = !1 : -1 !== c.indexOf("Mac OS X 10_7") && (n = !1)))), i = function () {
            function t(t, e, r, n) {
                this.user = t, this.urlMap = e, this.callback = r, this.dispathMessage2Listener = n, this.dispatchEvents = l(this.dispatchEvents, this), this.imgSendClear = l(this.imgSendClear, this), this.send = l(this.send, this)
            }
            var e, r, i;
            return e = [], i = [], r = [], t.prototype.connect = function (t) {
                ...
                try {
                    ...
                    return i = "pv" === e && 2 === t.length ? t[0].s : "", r = "undefined" == typeof Uint8Array || null === Uint8Array || s ? window.XMLHttpRequest && 7 !== a && !s ? u.compressToUTF16(JSON.stringify(t)) : u.compressToEncodedURIComponent(JSON.stringify(t)) : u.compressToUint8Array(JSON.stringify(t)), this.sendRemote(r, e, i), setTimeout(function (e) {
                        return function () {
                ...
                var u, d, c;
                return c = this.urlMap[e], window.grWaitTime = +Date.now() + 300, window.XMLHttpRequest && 7 !== a && !s ? (u = new XMLHttpRequest, "withCredentials" in u ? (u.open("POST", c + "?stm=" + +Date.now(), !0), u.withCredentials = !0, u.onreadystatechange = function (t) {
                    return function () {
                    ...
                    return function () {
                        return t.removeXDR(u), o && "" !== o ? t.user.updateSessionIdSendStatus(!0, o) : void 0
                    }
                    ...
                    return {}
                }, u.send(t), i.push(u))) : ("http:" === document.location.protocol && (c = c.replace("https://", "http://")), d = c + "?data=" + t + "&stm=" + +Date.now(), d.length <= 2036 && this.imgSend(d, o)), window.trackHostUrl = c
                ...
                return r = document.createElement("img"), r.width = 1, r.height = 1, r.onload = function (t) {
                    return function () {
                        return t.imgSendClear(r), e && "" !== e ? t.user.updateSessionIdSendStatus(!0, e) : void 0
                    }
                ...
                var e, r;
                for (e = 0, r = []; e < t.length;) this.dispathMessage2Listener(t[e]), r.push(e++);
                return r
            }, t
        }(), e.exports = i
    }, {
    ...
    11: [function (t, e, r) {
        ...
        n = t("./sender"), a = t("./utils"), o = t("./info"), i = function () {
            function t(t) {
                this.dispathMessage2Listener = s(this.dispathMessage2Listener, this), this.defaultSamplingFunc = s(this.defaultSamplingFunc, this), window.grcs = {}, this.listeners = [], this.user = o.user(), this.resetCS1 = !1, this.observer = t
            }
            return t.prototype.version = "0.7.26", t.prototype.scheme = "https://", t.prototype.host = "api.growingio.com", t.prototype.circleHost = ("https:" === document.location.protocol ? "https://" : "http://") + "www.growingio.com", t.prototype.endpoint = "/events", t.prototype.properties = {
                imp: !0,
                hashtag: !1,
                touch: !1,
                ignoreClck: !1,
                ...
                return "function" == typeof t ? this.listeners.push(t) : void 0
                ...
                if (o = window.navigator.userAgent.toLowerCase(), o.match(/(bot|crawler|spider|scrapy|jiankongbao|slurp|transcoder|networkbench|oneapm)/i)) {
                    ...
                    window.vds.imp = !1, e = !0
                }
                return i = new n(this.user, this.getUrlMap(), t, this.dispathMessage2Listener), i.connect({
                    isBot: !!e
                })
            }, t.prototype.dispathMessage2Listener = function (t) {
                var e, r;
                for (e = 0, r = []; e < this.listeners.length;) this.listeners[e](t), r.push(e += 1);
                return r
            }, t
        }(), e.exports = i
    }, {
    ...
    12: [function (t, e, r) {
        ...
        i = ["A", "BUTTON"], n = t("./guid"), o = {
            ...
            identityWindow: function () {
                var t, e;
                return t = n(), e = this.getWindowSourceName(), e && "grcw" === e || (window.top === window.self ? e = "grcw-outer-iframe" : (this.printWarning("检测到疑似window复写或者嵌套iframe。 window.name值: " + e), e = "grcw-inner-iframe")), window.grSource = {
                    name: e,
                    id: t
                }
            },
            getWindowSourceName: function () {
                var t, e;
                return e = null != window.name ? window.name : window.self.name, e && window.nameStorage && (t = e.split(/[:?]/), 3 === t.length && "nameStorage" === t[0] && (e = t[1])), e
            },
            ...
            parentOfLeafText: function (t) {
                ...
                for (s = t.childNodes, i = 0, a = s.length; a > i; i++) e = s[i], 3 === e.nodeType && (null != e.textContent ? r = e.textContent.trim() : null != e.data && (r = e.data.trim()), r.length > 0 && (n += r + " "));
                return n = n.replace(/[\n \t]+/g, " ").trim(), n.length > 0 && n.length < 50 ? o.processText(n) : void 0
            },
            ...
            processText: function (t) {
                return null == window.vds.textEncryptFunc ? t : null != t ? o.functionDeserialization(window.vds.textEncryptFunc).call(this, t) : void 0
            },
    ...
    16: [function (t, e, r) {
        ...
        if (s = "undefined" != typeof WebKitMutationObserver ? WebKitMutationObserver : MutationObserver, void 0 === s) throw console && console.error("DOM Mutation Observers are required."), console && console.error("https://developer.mozilla.org/en-US/docs/DOM/MutationObserver"), Error("DOM Mutation Observers are required");
        var d, c = function () {
            function t() {
        ...
        var h = function () {
            ...
            f = function () {
                function t(t, e, r, n, i) {
                    this.rootNode = t, this.mutations = e, this.selectors = r, this.calcReordered = n, this.calcOldPreviousSibling = i, this.treeChanges = new p(t, e), this.entered = [], this.exited = [], this.stayedIn = new c, this.visited = new c, this.childListChangeMap = void 0, this.characterDataOnly = void 0, this.matchCache = void 0, this.processMutations()
                }
                return t.prototype.processMutations = function () {
                    ...
                    for (var o = {}, a = this.treeChanges.keys(), n = 0; n < a.length; n++) {
                        ...
                        if (u.attributes && d.STAYED_IN === this.treeChanges.reachabilityChange(s) && d.STAYED_IN === this.matchabilityChange(s))
                            for (var c = s, h = u.getAttributeNamesMutated(), l = 0; l < h.length; l++) {
                                var i = h[l];
                                if (!e || e[i] || u.isCaseInsensitive && r[i]) {
                                    var p = u.getAttributeOldValue(i);
                                    p !== c.getAttribute(i) && (r && u.isCaseInsensitive && (i = r[i]), o[i] = o[i] || [], o[i].push(c))
                                }
                            }
                    }
                    return o
            ...
            b = function () {
                ...
                return Object.defineProperty(t.prototype, "caseInsensitiveTagName", {
                    ...
                    for (var i, o, a, s = [], u = /\s/, d = "Invalid or unsupported selector syntax.", c = 1, h = 2, l = 3, p = 4, f = 5, g = 6, b = 7, y = 8, S = 9, C = 10, O = 11, N = 12, x = 13, I = 14, E = c, A = 0; A < e.length;) {
                        var D = e[A++];
                        switch (E) {
                            case c:
                                if (D.match(v)) {
                                ...
                                if ("." == D) {
                                    r(), n(), i.tagName = "*", o.attrName = "class", o.contains = !0, E = p;
                                    break
                                }
                                if ("#" == D) {
                                    r(), n(), i.tagName = "*", o.attrName = "id", E = p;
                                    break
                                }
                                if ("[" == D) {
                                    r(), n(), i.tagName = "*", o.attrName = "", E = g;
                                    break
                                }
                                if (D.match(u)) break;
                                throw Error(d);
                            case h:
                                ...
                                if ("." == D) {
                                    n(), o.attrName = "class", o.contains = !0, E = p;
                                    break
                                }
                                if ("#" == D) {
                                    n(), o.attrName = "id", E = p;
                ...
                return t.prototype.disconnect = function () {
                    ...
                    if (void 0 === e) {
                        ...
                        for (var c = t.parentElement; c && "BODY" !== c.tagName && "HTML" !== c.tagName;) {
                            var h = "/" + c.tagName.toLowerCase(),
                                l = c.getAttribute("id");
                            if (l && null === l.match(/^[0-9]/) && (h += "#" + l), c.hasAttribute("class"))
                                for (var p = c.getAttribute("class").trim().split(/\s+/).sort(), f = 0; f < p.length; f++) p[f].length > 0 && null === o.exec(p[f]) && (h += "." + p[f]);
                    ...
                    switch (1 === g.nodeType && -1 !== u.indexOf(t.tagName) && (g.dom = t), g.nodeType) {
                        ...
                        case 1:
                            ...
                            if (e += "/", w.childNodes.length > 0) {
                                ...
                                var S, C, O = 0,
                                    N = -1 !== u.indexOf(w.tagName);
                                if (N)
                                    for (var x = w.firstChild; x; x = x.nextSibling)
                                        if (1 === x.nodeType && -1 === s.indexOf(x.tagName)) {
                                            N = !1;
                                            break
                                    ...
                                    if (S = w.hasAttribute("data-growing-info") ? w.getAttribute("data-growing-info") : null, C = w.hasAttribute("data-growing-idx") ? parseInt(w.getAttribute("data-growing-idx")) : -1, 1 === I.nodeType) {
                                        ...
                                        if (N && -1 !== s.indexOf(I.tagName) && (y = !1, !I.children || 0 === I.children.length)) continue; - 1 !== i.indexOf(I.tagName) && (O += 1, C = O), I.hasAttribute("data-growing-idx") && (O = parseInt(I.getAttribute("data-growing-idx")), C = O), I.hasAttribute("data-growing-info") && (S = I.getAttribute("data-growing-info"))
                                    }
                                    var E = this.serializeNode(I, e, O > 0 && C > 0 ? O : r, S || d);
                                    if (null === E) 3 != I.nodeType && (y = !1);
                                    else if ("undefined" != typeof E.childNodes) {
                                        y = !1, b = !0;
                                        for (var A = 0; A < E.childNodes.length; A++)
                                            if (E.childNodes[A].tagName) {
                                                b = !1;
                                                break
                                            } O > 0 && C > 0 ? E.idx = O : r && (E.idx = r), S ? E.obj = S : d && (E.obj = d), g.childNodes.push(E)
                                    } else {
                                        if ((0 === w.offsetWidth || 0 === w.offsetHeight) && "A" !== w.tagName && "BUTTON" !== w.tagName) return null;
                                        E.leaf && (r && (E.idx = r), d && (E.obj = d), g.childNodes.push(E))
                                    }
                                }
                            } else g.childNodes = [];
                            if (y)
                                ...
                                for (var k = w.firstChild; k; k = k.nextSibling)
                                    if ("use" === k.tagName && k.getAttribute("xlink:href")) {
                                ...
                                if (w.hasAttribute("data-growing-title") && w.getAttribute("data-growing-title").length > 0) g.text = w.getAttribute("data-growing-title");
                                    ...
                                    for (var k = w.firstChild; k; k = k.nextSibling)
                                        if ("use" === k.tagName && k.getAttribute("xlink:href")) {
                                            g.text = k.getAttribute("xlink:href");
                                            break
                                        } w.hasAttribute("data-growing-idx") && (g.idx = parseInt(w.getAttribute("data-growing-idx"))), w.hasAttribute("data-growing-info") && (g.obj = w.getAttribute("data-growing-info"))
                            }
                            g.path = e.slice(0, -1)
                    }
                    return g
                    ...
                    return d.forEach(function (t) {
                        ...
                        if (r && "BODY" !== r.tagName) {
                            var n = r.parentNode;
                            if (null == n) return;
                            for (var a = 1, s = n.childNodes[a - 1]; a <= n.childNodes.length; a++)
